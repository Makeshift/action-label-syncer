...
To create manifest of the current labels easily, using [label-exporter](https://github.com/brpaz/label-exporter) is recommended.
...
[actions-workflow-test]: https://github.com/brpaz/action-label-syncer/actions?query=workflow%3ACI
[actions-workflow-test-badge]: https://img.shields.io/github/workflow/status/brpaz/action-label-syncer/CI?label=CI&style=for-the-badge&logo=github
...
[release]: https://github.com/brpaz/action-label-syncer/releases
[release-badge]: https://img.shields.io/github/v/release/brpaz/action-label-syncer?style=for-the-badge&logo=github
[pkg.go.dev]: https://pkg.go.dev/github.com/brpaz/action-label-syncer?tab=overview
...
[dependabot]: https://github.com/brpaz/action-label-syncer/pulls?q=is:pr%20author:app/dependabot-preview
[dependabot-badge]: https://img.shields.io/badge/dependabot-enabled-blue?style=for-the-badge&logo=dependabot
[license]: LICENSE
[license-badge]: https://img.shields.io/github/license/brpaz/action-label-syncer?style=for-the-badge
